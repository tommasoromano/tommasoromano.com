...
function Projects( ) {
    ...
    return (
        <ProjectLayout>
            ...
            <p className="h2p mb-8">The list below represents a collection I find lovely and valuable, tracking my passion and dedication to Computer Science and Software Engineering: a {articlesText}</p>
            </section>
            <FilterArticles/>
        </ProjectLayout>
    )
