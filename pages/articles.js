...
function Projects( ) {
    ...
    return (
        <ProjectLayout>
            ...
            <p className="text-base mb-8 text-center"><span className="inline-btn">Disclamer:</span><br></br> the list below has no intention to be an ego showcase, but rather, it&apos;s a list I find nice and useful for myself, tracking my passion and dedication to Computer Science and Software Engineering</p>
